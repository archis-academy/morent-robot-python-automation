...
public class MoRentTask {
	
	public List<String> registration(WebDriver driver) throws InterruptedException{
...
//		Navigate to the registration page
	...
	public static void main(String[] args) throws InterruptedException {
		...
		MoRentTask ob =new MoRentTask();
		List<String> list=new ArrayList();
		list=ob.registration(driver);
